...
export const API_ENDPOINTS = {
  ...
  currency: {
    ...
    getAll: `${API_BASE_URL}/currency/getAll`,
    getByCode: (code) => `${API_BASE_URL}/currency/getOne/${code}`,
    create: `${API_BASE_URL}/currency/create`,
    update: (code) => `${API_BASE_URL}/currency/update/${code}`,
    delete: (code) => `${API_BASE_URL}/currency/delete/${code}`,
  },
  customers: {
    base: `${API_BASE_URL}/customer`,
    getAll: `${API_BASE_URL}/customer/getAll`,
    getById: (id) => `${API_BASE_URL}/customer/getOne/${id}`,
    create: `${API_BASE_URL}/customer/create`,
    update: (id) => `${API_BASE_URL}/customer/update/${id}`,
    delete: (id) => `${API_BASE_URL}/customer/delete/${id}`,
  },
  accounts: {
    base: `${API_BASE_URL}/account`,
  ...
  companies: {
    ...
    getAll: `${API_BASE_URL}/company/getAll`,
    getById: (id) => `${API_BASE_URL}/company/getOne/${id}`,
    create: `${API_BASE_URL}/company/create`,
    update: (id) => `${API_BASE_URL}/company/update/${id}`,
